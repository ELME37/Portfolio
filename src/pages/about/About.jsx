...
export default function About () {
    ...
    return (
        <div className='about' id='about'>
            <Layout>
                <h1 className='about__title'><span className='skills__hook blue'>&lt;</span> A propos <span className='skills__hook red'>/&gt;</span></h1>
                <Rectangle styles='description' 
                    children={
                        <>
                            <p className='presentation'>Je suis Mickaël TURQUAIS, <strong>Développeur Web - Mobile</strong> spécialisé en <strong>Javascript</strong> basé en <strong>Indre et Loire</strong>.</p>
                            <hr/>
                    ...
                    children={
                        <>
                            ...
                            <div className='modal__links'>
                                <HashLink to={ROUTES.skills} className="modal__link">
                                    Voir les compétences
                                </HashLink>
                                <HashLink to={ROUTES.projects} className="modal__link">
                                    Voir les projets
                                </HashLink>
                            </div>
                        </>
