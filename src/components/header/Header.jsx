            ...
            <nav className="header__navigation">
                <ul className="navigation__list">
                    <li className='navigation__list--item'>
                        <Link to={ROUTES.home} className="navigation__item--link">
                            ...
                            <span className='header__title--blue'>Accueil</span>
                        </Link>
                    </li>
                    <li className='navigation__list--item'>
                        <HashLink to={ROUTES.about} className="navigation__item--link">
                            ...
                            <span className='header__title--brown'>A Propos</span>
                        </HashLink>
                    </li>
                    <li className='navigation__list--item'>
                        <Link to={ROUTES.skills} className="navigation__item--link">
                            ...
                            <span className='header__title--blue'>Compétences</span>
                        </Link>
                    </li>
                    <li className='navigation__list--item'>
                        <Link to={ROUTES.projects} className="navigation__item--link">
                            ...
                            <span className='header__title--brown'>Projets</span>
                        </Link>
                    </li>
                    <li className='navigation__list--item'>
                        <Link to={ROUTES.contact} className="navigation__item--link">
                            ...
                            <span className='header__title--blue'>Contact</span>
                        </Link>
                    </li>
                </ul>
            </nav>
