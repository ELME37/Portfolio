                ...
                <ul className="navigation__list">
                    <li className='navigation__list--item'>
                        ...
                        >
                            ...
                            <p className={`header__title--blue ${currentSection === 'Accueil' ? 'actif' : 'inactif'}`}>{currentSection === 'Accueil' ? 'Accueil' : 'Accueil'}</p>
                        </NavLink>
                    </li>
                    <li className='navigation__list--item'>
                        <HashLink to={ROUTES.about} className={`navigation__item--link ${headerScroll === 'scrolled--about' ? 'scrolled--about' : ''}`}>
                            ...
                            <p className={`header__title--brown ${currentSection === 'A Propos' ? 'actif' : 'inactif'}`}>{currentSection === 'A Propos' ? 'A Propos' : 'A propos'}</p>
                        </HashLink>
                    </li>
                    <li className='navigation__list--item'>
                        <HashLink to={ROUTES.skills} className={`navigation__item--link ${headerScroll === 'scrolled--skills' ? 'scrolled--skills' : ''}`}>
                            ...
                            <p className={`header__title--blue ${currentSection === 'Compétences' ? 'actif' : 'inactif'}`}>{currentSection === 'Compétences' ? 'Compétences' : 'Compétences'}</p>
                        </HashLink>
                    </li>
                    <li className='navigation__list--item'>
                        <HashLink to={ROUTES.projects} className={`navigation__item--link ${headerScroll === 'scrolled--projects' ? 'scrolled--projects' : ''}`}>
                            ...
                            <p className={`header__title--brown ${currentSection === 'Projets' ? 'actif' : 'inactif'}`}>{currentSection === 'Projets' ? 'Projets' : 'Projets'}</p>
                        </HashLink>
                    </li>
                    <li className='navigation__list--item'>
                        <HashLink to={ROUTES.contact} className={`navigation__item--link ${headerScroll === 'scrolled--contact' ? 'scrolled--contact' : ''}`}>
                            ...
                            <p className={`header__title--blue ${currentSection === 'Contact' ? 'actif' : 'inactif'}`}>{currentSection === 'Contact' ? 'Contact' : 'Contact'}</p>
                        </HashLink>
                    </li>
                </ul>
            </nav>
